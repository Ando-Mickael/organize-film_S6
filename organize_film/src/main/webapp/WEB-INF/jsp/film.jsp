                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="pt-4 pb-2">
                                            <h5 class="card-title text-center pb-0 fs-4">Selection Film</h5>
                                            <p class="text-center small">Organisez votre propre film en un clic!</p>
                                        </div>

                                        <form action="planning" method="get" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <select name="idFilm">
                                                        ...
                                                        <option value="<%out.print(film.getId());%>">
                                            ...
                                            <div class="col-12">
                                                <label for="mdp" class="form-label">Date debut tournage</label>
                                                <input type="date" name="dateDebutTournage" value="2023-03-01" class="form-control" id="mdp" required>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <p class="small mb-0">Voir film? <a href="listFilms">Click here</a></p>
                                            </div>
                                        </form>

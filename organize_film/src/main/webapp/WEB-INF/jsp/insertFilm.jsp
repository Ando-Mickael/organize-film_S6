...
<html lang="en">
    ...
    <%
        ...
        List<Auteur> listAuteur = (List<Auteur>) request.getAttribute("auteur");
                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="films" method="GET" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <select name="auteur">
                                                ...
                                                <option value="<% out.print(listAuteur.get(i).getId()); %>"><% out.print(listAuteur.get(i).getNom()); %></option>
                                                <% }%>
                                            </select>

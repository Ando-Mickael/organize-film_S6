            ...
            <div class="container">
                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">SCENE-FILM <span>| Today</span></h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row">#<%out.print(scene.getFilmid());%></th>
                                        <td><a href="#" class="text-primary"><%out.print(scene.getNom());%></a></td>
                                        <th scope="row"><%out.print(scene.getDuree());%> mn</th>
                                        <th scope="row">#<%out.print(scene.getPlateauid());%></th>
                                        <td><a href="listSceneDetails?idScene=<%out.print(scene.getId());%>"><span class="badge bg-success">Details</span></a></td>
                                    </tr>
